...
@section('page')
        ...
        <div class="card-body">
            <form>
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <input type="text" class="form-control text-center" name="id" placeholder="Item Code" value="{!! $_GET['id'] ??'' !!}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
    ...
    <a href="/admin/content/list/excel?{!! http_build_query(Request()->all()) !!}" class="btn btn-primary">Export as xls</a>
    <div class="h-10"></div>
    <section class="card">
        <div class="card-body">
                ...
                <table class="table table-bordered table-striped mb-none" id="datatable-details">
                    ...
                    @foreach($lists as $item)
                        ...
                        <tr>
                            ...
                            <td class="text-center">@if(productTopViewer($item->id)){!! productTopViewer($item->id) !!}@endif</td>
                            <td class="text-center">
