    ...
    <section class="card">
        <div class="card-body">
            ...
            <form action="/admin/notification/store" class="form-horizontal form-bordered" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-11" >
                        <select  name="recipent_type" class="form-control select2 recipent_selection">
                                <option value=""></option>
                                <option value="userone" @if(isset($_GET['recipent_type']) && $_GET['recipent_type']=='userone') selected @endif>{{{ trans('admin.single_user') }}}</option>
                                <option value="users" @if(isset($_GET['recipent_type']) && $_GET['recipent_type']=='users') selected @endif>{{{ trans('admin.users_list') }}}</option>
                                <option value="category" @if(isset($_GET['recipent_type']) && $_GET['recipent_type']=='category') selected @endif>{{{ trans('admin.user_groups') }}}</option>
                ...
                <div class="form-group @if(!isset($_GET['recipent_type']) || $_GET['recipent_type']!='userone') recipent @endif" id="userone">
