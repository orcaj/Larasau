@extends('admin.newlayout.layout',['breadcom'=>['Support','Departments','Edit']])
@section('title')
    {{{ trans('admin.th_edit') }}} {{{ trans('admin.departments') }}}
@endsection
@section('page')
    <div class="card">
        <div class="card-body">
            <div class="tabs">
                <ul class="nav nav-pills">
                    <li class="nav-item">
                        <a href="#list" class="nav-link" data-toggle="tab"> {{{ trans('admin.departments') }}} </a>
                    </li>
                    <li class="nav-item">
                        <a href="#newitem" class="nav-link" data-toggle="tab">{{{ trans('admin.new_department') }}}</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div id="list" class="tab-pane ">
                        <table class="table table-bordered table-striped mb-none" id="datatable-details">
                            ...
                            <tr>
                                ...
                                <th class="text-center" width="100">{{{ trans('admin.support_tickets') }}}</th>
