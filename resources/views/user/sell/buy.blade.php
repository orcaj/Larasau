...
@section('tab')
    ...
    @if(count($list) == 0)
        <div class="text-center">
            <img src="/assets/images/empty/dashboardbought.png">
            <div class="h-20"></div>
    ...
    @else
        ...
        @if($user['vendor'] == 0 && get_option('default_customer_dashboard_cover') != '')
            <a href="/category"><img src="{!! get_option('default_customer_dashboard_cover') !!}" class="img-responsive"></a>
        @endif
    </div>
    @endif
@endsection
