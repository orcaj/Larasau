            ...
            <div class="form-group">
                ...
                <div class="col-md-3 tab-con">
                    <select name="gateway" class="form-control">
                        @if(get_option('gateway_paypal') == 1)<option value="paypal">Paypal</option>@endif
                        @if(get_option('gateway_payu') == 1)<option value="paypal">Payu</option>@endif
                        @if(get_option('gateway_paytm') == 1)<option value="paytm">Paytm</option>@endif
                        @if(get_option('gateway_paystack') == 1)<option value="paystack">Paystack</option>@endif
                    </select>
                </div>
